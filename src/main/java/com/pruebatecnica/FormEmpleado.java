...
public class FormEmpleado extends javax.swing.JFrame {
    ...
    public FormEmpleado() {
        ...
        cn.estableceConexion();*/
        
        CEmpleados ce = new CEmpleados();
        ce.mostrarEmpleados(tbTotalEmpleados);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Empelado"));
        ...
        btnSolicitud.setText("Realizar Solicitud");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        CEmpleados ce = new CEmpleados();
        ce.insertarEmpleado(txtFecha, txtNombre, txtSalario);
        ce.mostrarEmpleados(tbTotalEmpleados);
    ...
    private void btnSolicitudActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSolicitudActionPerformed
        FormSolicitud fs = new FormSolicitud();
        fs.setVisible(true);
        dispose();
